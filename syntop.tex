...
\begin{rmk}
  ...
  Thus, our ``approach prometric spaces'' are at least one reasonable constructive notion of approach space.
\end{rmk}
...
\begin{thm}\label{thm:qapt-pmetl}
  ...
  This single distance is a lower prometric on $X$, and this construction defines a fully faithful functor $\mathbf{QApt} \to \PMetl$, where $\mathbf{QApt}$ is the full subcategory of $\APreord$ on the quasi-apartnesses.
  And the composite $\mathbf{QApt} \to \PMetl \to \PMetOrdl$ is an equivalence of categories, whose inverse is the anti-preorder construction from \cref{thm:pmet-apreord}.
  Moreover, this prometric is\dots
  \begin{enumerate}
...
\begin{proof}
  ...
  Functoriality and full-faithfulness of $\mathbf{QApt} \to \PMetl$ follows from~\eqref{eq:up7}.
  ...
  Thus we have another fully faithful functor $\PMetOrdl \to \mathbf{QApt}$, which it is easy to see defines an inverse to the above.
