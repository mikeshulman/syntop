...
\begin{defn}
  ...
  \begin{enumerate}[resume]
  \item for any distance $d_1$ there is a distance $d_2$ such that $d_1(x,y)\le d_2(y,x)$ for all $x,y\in X$.
  \end{enumerate}
...
\begin{rmk}
  ...
  However, it is unclear how to construct an ``Alexandrov apartness'' from an irreflexive comparison $\oapt$; the comparison property $x\oapt y \lor y\oapt z$ seems insufficient, constructively, to ensure transitivity of any $\bowtie$ defined naturally from it.
...
However, there is also the stronger \emph{uniform} information, as defined by the category of uniformly continuous functions.
