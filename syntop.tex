...
\begin{defn}
  ...
  We have categories $\LAQUnif,\RAQUnif,\QUnifApt,\AQUnifnn$, and $\ldAQUnif$.
\end{defn}
...
\begin{thm}
  ...
  This defines a fully faithful functor whose image consists of the quasi-uniform spaces with a smallest entourage.

  Dually, if $X$ is a left or right anti-preorder, then its relation $\oapt$ is a base for a left or right anti-quasi-uniformity.
  This defines two fully faithful functors whose images consists of the (left or right) anti-quasi-uniform spaces with a largest anti-entourage, and under which the (quasi-)apartness relations correspond to the (quasi-)uniform apartness spaces.

  Furthermore, these three functors
  \[ \Preord\to\QUnif\qquad \LAPreord \to \LAQUnif \qquad \RAPreord \to \RAQUnif \]
  have right adjoints.
\end{thm}
