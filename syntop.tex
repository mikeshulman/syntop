...
The differences between the various kinds of real numbers, when used as distances, are illustrated by the following example.\fxnote{This is a special case of something in \cref{sec:point-point}; is it worthwhile to repeat it here for pedagogical emphasis?}
