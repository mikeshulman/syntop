...
\begin{eg}
  ...
  Combining this with the previous example, we find that \emph{prodiscrete spaces} are naturally upper prometric spaces.
\end{eg}
...
\begin{eg}\label{eg:aunif-topgp}
  ...
  Note that transitivity of the original structure comes for free.
  This is not anything special about apartness, though: a pretopological neighborhood group is automatically topological as well.
