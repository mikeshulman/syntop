...
TODO: The terminology ``apartness relation'' for an $\apart$ satisfying the strong disjunctive comparison axiom, especially if extended to ``quasi-apartness'' and ``quasi-uniform apartness space'', suggests that a ``topological apartness space'' should satisfy some similar disjunctive condition.  Indeed,~\cite{bridges-vita} require an apartness space to satisfy ``weak local decomposability'', although arguably full local decomposability would be a better analogue.
...
\begin{eg}\label{eg:alexandrov}
  ...
  % TODO: Something about the $\oapt$-topology defined using a $\vee$...
\end{eg}
